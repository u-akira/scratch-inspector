defmodule ScratchInspector.Parser do
  ...
  defp opcode_label("data_hidevariable"), do: "変数 [VARIABLE] を隠す"
  ...
  defp opcode_label("motion_goto_menu"), do: "[TO]"
  defp opcode_label("motion_gotoxy"), do: "x座標を [X]、 y座標を [Y] にする"
  defp opcode_label("motion_glideto"), do: "[SECS] 秒で [TO] へ行く"
  defp opcode_label("motion_glideto_menu"), do: "[TO]"
  defp opcode_label("motion_glidesecstoxy"), do: "[SECS] 秒で x座標を [X]に、 y座標を [Y] に変える"
  defp opcode_label("motion_pointindirection"), do: "[DIRECTION] 度に向ける"
  defp opcode_label("motion_pointtowards"), do: "[TOWARDS] へ向ける"
  defp opcode_label("motion_pointtowards_menu"), do: "[TOWARDS]"
  ...
  defp opcode_label("control_create_clone_of_menu"), do: "[CLONE_OPTION]"
